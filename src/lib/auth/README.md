...
{canWriteContent(Astro.locals) && <button>Create New Post</button>}

{isAdmin(Astro.locals) && <a href="/a">Admin Dashboard</a>}
```
...
{canWriteContent(Astro.locals) && <a href="/content/create">Create Content</a>}

{canEditContent(Astro.locals) && <a href="/content/edit">Edit Content</a>}

{canManageUser(Astro.locals) && <a href="/users">Manage Users</a>}

{hasRole(Astro.locals, 'admin') && <a href="/a">Admin Panel</a>}

{isAdmin(Astro.locals) && <button>Admin Action</button>}
```

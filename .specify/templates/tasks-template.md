...
**Tests**: The examples below include test tasks. Tests are MANDATORY per our constitution's Test-Driven Development principle - they must be written before implementation.
...
- [ ] T010 [P] [US1] Contract test for [endpoint] in tests/contract/test_[name].spec.ts
- [ ] T011 [P] [US1] Integration test for [user journey] in tests/integration/test_[name].spec.ts
...
- [ ] T018 [P] [US2] Contract test for [endpoint] in tests/contract/test_[name].spec.ts
- [ ] T019 [P] [US2] Integration test for [user journey] in tests/integration/test_[name].spec.ts
...
- [ ] T024 [P] [US3] Contract test for [endpoint] in tests/contract/test_[name].spec.ts
- [ ] T025 [P] [US3] Integration test for [user journey] in tests/integration/test_[name].spec.ts
